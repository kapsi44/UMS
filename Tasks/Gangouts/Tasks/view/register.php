...
include_once '../controller/validationPhp.php';
			            ...
			            <div class="row">
				            <div class="col-xs-12 col-sm-6 col-md-6">
					            <div class="form-group">
                                  <?php inputText("fn","First Name", "1"); ?>
					            </div>
				            </div>
				            <div class="col-xs-12 col-sm-6 col-md-6">
					            <div class="form-group">
						          <?php inputText("ln", "Last Name", "2"); ?>  
					            </div>
				            </div>
			            </div>
			            <div class="form-group">
				           <?php inputText("username","User Name", "3"); ?>
			            </div>
			            <div class="form-group">
				           <?php inputEmail("email", "Email Address", "4");  ?> 
			            </div>
			            <div class="row">
				            <div class="col-xs-12 col-sm-6 col-md-6">
					            <div class="form-group">
						            <?php inputPassword("password", "Password", "5"); ?>
					            </div>
				            </div>
				            <div class="col-xs-12 col-sm-6 col-md-6">
					            <div class="form-group">
						            <?php inputPassword("confirmPassword","Re-enter Password", "6"); ?>
					            </div>
				            </div>
			            </div>
                        <div class="row">
				            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="bs-docs-example">
                                    <?php inputText("mobile","Mobile No.", "7");?>
                                </div>
                                </div>
                             </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <h4><label for="interest"> BirthDay</label></h4>                                                          
                         				...
                         				<select class="selectpicker" data-style="btn-primary" data-width="auto" style="display: none;" name="day">
			                              ...
			                              <select class="selectpicker" data-style="btn-primary" data-width="auto" style="display: none;" name="month">
			                                      <?php monthOption("January,Febuary,March,April,May,June,July,August,September,October,November,December"); ?>
			                           </select>
					            ...
					            <div class="form-group">
						             <div class="bs-docs-example">
                                        <h4><label for="interest"> Area of Interest</label></h4>                                                          
                                            ...
                                            <?php option("Singing,Dancing,Cooking,Painting,Surfing,Sports,Reading,Teaching,Fishing");?>                
                                          </select>
                                    </div>
                                  </div>
				            </div>
				            ...
				            <div class="col-xs-12 col-sm-6 col-md-6">
					            <div class="form-group">
                                  ...
                                  <select class="selectpicker" name="qualify" id="education" data-style="btn-info" multiple="" style="display: none;">
                                       <?php option("10th,12th,B.E,B.Tech,MCA,Phd"); ?>       
                                  </select>
					            </div>
				            </div>
                        </div> 
